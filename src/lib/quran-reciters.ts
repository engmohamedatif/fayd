...
export const MP3_RECITERS: MP3Reciter[] = [
  ...
  { id: "basit-mrt", name: "عبد الباسط عبد الصمد (مرتل)", server: "https://server7.mp3quran.net/basit/" },
  { id: "abdulbasit-mjw", name: "عبد الباسط عبد الصمد (مجود)", server: "https://server7.mp3quran.net/basit/Almusshaf-Al-Mojawwad/" },
  { id: "tblawi-mrt", name: "محمد الطبلاوي (مرتل)", server: "https://server12.mp3quran.net/tblawi/" },
